...
bot = telebot.TeleBot('7880790298:AAHuoXbLALlgGsIbZ2RCIJ2c7rPGz8UCHpA')
...
allowed_user_ids = ['6173387595', '5687234886', '1630005621'] 
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, \n✨✨Premium \nAttack1 STARTED 🚀 BY BABA.\n\n📡 𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n🔌 𝐏𝐨𝐫𝐭: {port}\n⏱️ 𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n\n𝐌𝐞𝐭𝐡𝐨𝐝: Premium \nBy https://t.me/blackhostbaba"
    bot.reply_to(message, response)
